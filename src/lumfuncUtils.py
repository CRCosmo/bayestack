...
def LF_SFRD(L, q, params=None, paramsList=None, family=None,z=0):
    ...
    elif 'mat' in family or 'LFdpl_dpl'==family:
        L=L
        #L*=(1.4/3)**(-.7)
...
def LF(S, z, dlds, Vmax, dl, params=None, paramsList=None, inta=None, area=None, family=None,L=None,SFRD=False,bypassLim=False):
    ...
    if family in ['LFdpl_dpl_z','LFevol_dpl','LFevol_logn','LFevol_dpl_L','LFevol_logn_L']:
    ...
    if family in ['LFlognorm','LFpl_lognorm','LFlognorm_dpl']:
