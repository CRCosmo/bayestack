...
def main():
    ...
    if modelFamily in ['LFdpl_dpl_z','LFevol_dpl','LFevol_logn']:
    ...
    #plt.plot(bins3,numpy.log10(phi_sf)-dm,'--c', label=' SF')
    #plt.plot(bins3,numpy.log10(phi_agn)-dm,'-.c', label='local agn')
    
    #plt.plot(numpy.log10(10**bins3),numpy.log10(faint)-dm,'--r', label='sf')
    ...
    #plt.plot(bins3,numpy.log10(phi_sf_n),'--r', label='local sf nov')
    #plt.plot(bins3,numpy.log10(phi_agn_n),'--r', label='local agn nov')
    ...
    plt.errorbar(numpy.log10(10**bins3), numpy.log10(nov_Tot_n),fmt='--k',label='Total fit Novak et al 2018')
    '''
